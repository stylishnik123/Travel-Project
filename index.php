...
<div id="maincontent">
<p><a href="#" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image7','','css/Shimla Town-10.jpg',1)"><img src="css/shimla snow.jpg" name="Image7" width="190" height="130" border="0" id="Image7" /></a> <a href="#" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image8','','css/goabeach.jpg',1)"><img src="css/goa.jpg" name="Image8" width="190" height="130" border="0" id="Image8" /></a> <a href="#" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image9','','css/agrafort.jpg',1)"><img src="css/Copy of choki.jpg" name="Image9" width="190" height="130" border="0" id="Image9" /></a> <a href="#" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image10','','css/k4.jpg',1)"><img src="css/k5.jpg" name="Image10" width="190" height="130" border="0" id="Image10" /></a></p>
<br/>
WELCOME TO TRIP TRAVEL AGENCY<br/>
<br/>
<p>
For Over 10 years,TRIP TRAVEL AGENCY is providing its . We book Train Tickets, Bus Seat Book and Taxi Booking. We are providing tickets and other services in a nominal rate. We provide Luxries Buses, Taxies to Standard versions. So a middle level to higher level customer enjoy our services. For Over 10 years,TRIP TRAVEL AGENCY is providing its . We book Train Tickets, Bus Seat Book and Taxi Booking. We are providing tickets and other services in a nominal rate. We provide Luxries Buses, Taxies to Standard versions. So a middle level to higher level customer enjoy our services. </p>
<p>&nbsp;</p>
</div>
<div id="sidebar">
