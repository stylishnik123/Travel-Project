...
$sql="insert into travel1.train values('$_POST[trainid]','$_POST[depart]','$_POST[dest]','$_POST[schedule]','$_POST[dtime]','$_POST[acfirst]','$_POST[acsecond]','$_POST[acchair]','$_POST[firstclass]','$_POST[secondclass]','$_POST[thirdclass]')";
