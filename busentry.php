...
<div id="maincontent">
  ...
  <form id="form1" name="form1" method="post" enctype="multipart/form-data" action="businsert.php">
    <table width="800" border="0">
      <tr>
        <td width="400"><div align="center">BUSID</div></td>
      ...
      <tr>
        <td><div align="center">SEAT</div></td>
        <td><div align="center">
      ...
      <tr>
        <td><div align="center">FARE</div></td>
        <td><div align="center">  
           <input type="text" name="fare" id="fare" /></div></td>
      </tr>
       <tr>
        <td><div align="center">MODEL</div></td>
        <td><div align="center">  
           <input type="text" name="model" id="model" /></div></td>
      </tr>
       <tr>
        <td><div align="center">PICNAME</div></td>
        <td><div align="center">  
       ...
       <tr>
        ...
        <td><div align="center">  
           <input type="text" name="schedule" id="schedule" /></div></td>
      </tr>
       <tr>
        <td><div align="center">TIME</div></td>
        <td><div align="center">  
           <input type="text" name="time" id="time" /></div></td>
      </tr>
      <tr>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
