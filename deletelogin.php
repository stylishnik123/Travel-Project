...
$nm=$_POST['lname'];
$sql="delete from travel1.login where login_name='$nm' ";
if (!mysql_query($sql,$con))
{
die('error :' . mysql_error());
}
echo " <br/>record deleted from login";
/*********************************/
$sql="delete from travel1.user_info where login_name='$nm' ";
if (!mysql_query($sql,$con))
{
die('error :' . mysql_error());
}
echo "<br/> record deleted from user information";
/*********************************/
$sql="delete from travel1.carbook where username='$nm' ";
if (!mysql_query($sql,$con))
{
die('error :' . mysql_error());
}
echo " <br/>record deleted from car book";
/*********************************/
$sql="delete from travel1.busbook where username='$nm' ";
if (!mysql_query($sql,$con))
{
die('error :' . mysql_error());
}
echo "</br> record deleted from bus book";
/*********************************/
$sql="delete from travel1.trainbook where username='$nm' ";
if (!mysql_query($sql,$con))
{
die('error :' . mysql_error());
}
echo "</br> record deleted from train book";
