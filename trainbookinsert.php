...
$result=mysql_query("select  destination from travel1.train where departure_station='" . $_POST['dept'] . "'");
$n="false";
while($row=mysql_fetch_array($result))
{
if( $row['destination'] == $_POST['dest'])
{
...
if($n=="false")
echo "OOPS! This destination is not available <br/>";
if($n=="true")
{
...
*************************
*/
$result=mysql_query("select  train_id  from travel1.train where departure_station='" . $_POST['dept'] . "' and destination= '" . $_POST['dest'] ."'");
$z="false";
while($row=mysql_fetch_array($result))
{
if( $row['train_id'] == $_POST['trainid'])
{
...
/*********************************************************/
if($z=="false")
echo "OOPS! This train  is not available in this place <br/>";
if($z=="true")
{


$sql="insert into travel1.trainbook values('$_SESSION[username]','$_POST[dept]','$_POST[dest]','$_POST[class]','$_POST[trainid]','$_POST[date1]','$_POST[noofseats]','$_POST[emailid]','$_POST[paymentmode]')";
if (!mysql_query($sql,$con))
{
die('error :' . mysql_error());
}
echo "CONGRATULATIONS!!YOUR SEAT IS BOOKED.<br/>Our customer care executive will contact you soon!!";
mysql_close($con);
}
}
?>
