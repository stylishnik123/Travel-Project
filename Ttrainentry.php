...
<div id="maincontent">
  ...
  <form id="form1" name="form1" method="post" action="traininsert.php">
    <table width="800" border="0">
      <tr>
        <td width="400"><div align="center">TRAIN ID</div></td>
        <td width="400"><div align="center">
          <input type="text" name="trainid" id="trainid" />
        </div></td>
      </tr>
      <tr>
        <td><div align="center">DEPARTURE STATION</div></td>
        <td><div align="center">
      ...
      <tr>
        <td><div align="center">SCHEDULE</div></td>
        <td><div align="center">
      ...
      <tr>
        <td><div align="center">DEPARTURE TIME</div></td>
        <td><div align="center">
          <input type="text" name="dtime" id="dtime" />
        </div></td>
      </tr>
      <tr>
        <td><div align="center">AC FIRST CLASS</div></td>
        <td><div align="center">
          <input type="text" name="acfirst" id="acfirst" />
        </div></td>
      </tr>
      <tr>
        <td><div align="center">AC SECOND CLASS</div></td>
        <td><div align="center">
          <input type="text" name="acsecond" id="acsecond" />
        </div></td>
      </tr>
      <tr>
        <td><div align="center">AC CHAIR CLASS</div></td>
        <td><div align="center">
          <input type="text" name="acchair" id="acchair" />
        </div></td>
      </tr>
      <tr>
        <td><div align="center">FIRST CLASS</div></td>
        <td><div align="center">
          <input type="text" name="firstclass" id="firstclass" />
        </div></td>
      </tr>
      <tr>
        <td><div align="center">SECOND CLASS</div></td>
        <td><div align="center">
          <input type="text" name="secondclass" id="secondclass" />
        </div></td>
      </tr>
      <tr>
        <td><div align="center">THIRD CLASS</div></td>
        <td><div align="center">
          <input type="text" name="thirdclass" id="thirdclass" />
        </div></td>
      </tr>
      <tr>
        <td>&nbsp;</td>
