...
<div id="maincontent">
<form id="form1" name="form1" method="post" action="forget2.php">
    <?php
...
{
if( $row['login_name'] == $_POST['nm'] )
{
$_SESSION['ln']=$_POST['nm'];
echo "Security Question " .  $row['security_question'];
echo "<br/>Enter Security Answer: ";
echo '<input type="text" name="sa" id="sa" />';
