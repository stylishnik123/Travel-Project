...
$str="select * from travel1.train where departure_station = '" . $_SESSION['dp'] . "' and destination= '". $_POST['dest'] . "'";
...
<th>Ac second class</th>
<th>Ac chair class</th>
<th>First class</th>
<th>Second class</th>
<th>Third class</th>
</tr>";
...
echo " <td> " . $row['deaprture_time'] . "</td>";
echo " <td> " . $row['ac_first_class'] . "</td>";
echo " <td> " . $row['ac_second_class'] . "</td>";
echo " <td> " . $row['ac_chair_class'] . "</td>";
