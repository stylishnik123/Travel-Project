...
$sql="insert into travel1.login values('$_POST[lname]','$_POST[password]','$_POST[sques]','$_POST[sans]','$_POST[emailid]')";
...
mysql_close($con);
echo "<a href=\"signupform2.php\">";
echo "Welcome User <br/> click here to go to user information!";
?>
