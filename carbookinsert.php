...
$sql="insert into travel1.carbook values('$_SESSION[username]','$_POST[model]','$_POST[dest]','$_POST[noofperson]','$_POST[emailid]','$_POST[date1]')";
if (!mysql_query($sql,$con))
{
die('error :' . mysql_error());
}
echo "CONGRATULATIONS!!CAR IS BOOKED.<br/>Our customer care executive will contact you soon!!";
mysql_close($con)
?>
