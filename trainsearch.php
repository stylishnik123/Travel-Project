...
<form id="form1" name="form1" method="post" action="trainsearch2.php">
     Select Destination Station<select name="dest" id="dest" >

    <?php
$_SESSION['dp']=$_POST['dept'];
...
$result=mysql_query("select distinct destination from travel1.train where departure_station= '" . $_POST['dept'] . "'" );
