...
<body onload="MM_preloadImages('css/goabeach.jpg','css/agrafort.jpg','css/k4.jpg')">
<div id="pagewrapper">
<div id="header"> 
<marquee>
...
<tr>
  ...
  <form id="form1" name="form1" method="post" action="traindelete.php">
    <h1>WARNING!</h1>
    <h3>Deleting Login Delete all the information Be Cautious!</h3>
    <p>Enter Train Id
