...
<div id="maincontent">
  ...
  <form id="form1" name="form1" method="post" action="feedbackinsert.php">
    <table width="800" border="0">
      <tr>
        <td width="400"><div align="center">NAME</div></td>
        <td width="400"><div align="center">
          <input type="text" name="name" id="name" />
        </div></td>
      </tr>
      <tr>
        <td height="24"><div align="center">EMAIL</div></td>
        <td><div align="center">
      ...
      <tr>
        ...
        <td rowspan="4"><div align="center">
          <textarea name="feedback" cols="25" rows="4">
          </textarea>
        </div></td>
      </tr>
      <tr>
