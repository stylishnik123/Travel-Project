...
$result=mysql_query("select model from travel1.bus where to1='" . $_POST['dest'] . "'");
$n="false";
...
if($n=="false")
echo "OOPS! This Model is not Available for Current Destination <br/>Please Choose Another Model";
if($n=="true")
{
$sql="insert into travel1.busbook values('$_SESSION[username]','$_POST[dest]','$_POST[model]','$_POST[noofperson]','$_POST[emailid]','$_POST[paymode]','$_POST[date1]')";
