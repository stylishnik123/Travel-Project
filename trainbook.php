...
<div id="maincontent">
  <table width="800" border="1">
    ...
    <tr>
      <td><div align="right"><a href="welcomeuser.php" target="_self">BACK</a></div></td>
    </tr>
  </table>
  <br/>
  
  <form id="form1" name="form1" method="post" action="trainbookinsert.php">
    <table width="800" border="0">
      <tr>
        <td width="400"><div align="center">USERNAME</div></td>
...
$result=mysql_query("select distinct departure_station from travel1.train");
...
?>
      ...
      <tr>
        ...
        <td><div align="center">DESTINATION
...
mysql_select_db("travel1",$con);
$result=mysql_query("select distinct destination from travel1.train");
while($row=mysql_fetch_array($result))
{ 
...
?>
      ...
      <tr>
        <td><div align="center">TRAIN ID</div></td>
        <td><div align="center">
...
mysql_select_db("travel1",$con);
$result=mysql_query("select distinct train_id from travel1.train");
while($row=mysql_fetch_array($result))
{ 
...
?>
      ...
      <tr>
        <td><div align="center">NO OF SEATS</div></td>
        <td><div align="center">
