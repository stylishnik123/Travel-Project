...
<div id="maincontent">
  ...
  <form id="form1" name="form1" method="post" action="busbookinsert.php">
...
$result=mysql_query("select distinct to1 from travel1.bus");
while($row=mysql_fetch_array($result))
{ 

echo '<option value="' . $row['to1'] . '">' . $row['to1'] . '</option>';
...
mysql_select_db("travel1",$con);
$result=mysql_query("select distinct model from travel1.bus");
while($row=mysql_fetch_array($result))
{ 
...
?>
      ...
      <tr>
        <td><div align="center">NO OF PERSON</div></td>
        <td><div align="center">
          <input type="text" name="noofperson" id="noofperson" />
        </div>          </td>
      </tr>
